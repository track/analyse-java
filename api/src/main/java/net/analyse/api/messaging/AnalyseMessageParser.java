package net.analyse.api.messaging;
...
/**
 * Parser for Analyse plugin messages.
 * Used by proxy plugins to parse incoming messages from backend servers.
 */
public final class AnalyseMessageParser {

  private static final Gson GSON = new GsonBuilder().create();
  private static final Type MAP_TYPE = new TypeToken<Map<String, Object>>() {}.getType();

  private AnalyseMessageParser() {
  }
  ...
  public static ParsedMessage parse(byte[] data) throws IOException {
    ...
    if (AnalyseMessaging.TYPE_EVENT.equals(type)) {
      return parseEventMessage(in);
    } else if (AnalyseMessaging.TYPE_CONVERSION.equals(type)) {
  ...
  public abstract static class ParsedMessage {
    ...
    public boolean isEvent() {
      return AnalyseMessaging.TYPE_EVENT.equals(type);
    }
    ...
    public boolean isConversion() {
      return AnalyseMessaging.TYPE_CONVERSION.equals(type);
    }
  }
  ...
  public static class EventMessage extends ParsedMessage {
    ...
    public EventMessage(
      ...
      super(AnalyseMessaging.TYPE_EVENT);
  ...
  public static class ConversionMessage extends ParsedMessage {
    ...
    public ConversionMessage(
      ...
      super(AnalyseMessaging.TYPE_CONVERSION);
      this.playerUuid = playerUuid;
      this.playerUsername = playerUsername;
