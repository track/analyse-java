...
public abstract class PaperAction implements Action<Player> {
  ...
  protected final ServerStatsPlugin plugin;
  protected final ActionData data;

  protected PaperAction(ServerStatsPlugin plugin, ActionData data) {
    this.plugin = plugin;
    this.data = data;
  }
   ...
   */
  public static PaperAction create(ServerStatsPlugin plugin, ActionData data) {
