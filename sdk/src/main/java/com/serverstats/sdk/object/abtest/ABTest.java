 ...
 */
@Getter
public class ABTest implements com.serverstats.api.object.abtest.ABTest {
  ...
  @Override
  public com.serverstats.api.object.abtest.Variant assignVariant(UUID playerUuid) {
  ...
  @Override
  public com.serverstats.api.object.abtest.Variant getVariant(String variantKey) {
    if (variants == null) {
      return null;
    }
