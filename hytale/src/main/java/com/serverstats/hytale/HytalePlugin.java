package com.serverstats.hytale;
...
import com.serverstats.hytale.manager.ABTestManager;
import com.serverstats.hytale.manager.SessionManager;
import com.serverstats.hytale.task.HeartbeatTask;
import com.serverstats.hytale.update.HytaleUpdateChecker;
 ...
 */
public class HytalePlugin extends JavaPlugin implements ServerStatsPlatform {
  ...
  protected void setup() {
    super.setup();
    getLogger().atInfo().log("Loading ServerStats...");

    // Load configuration
    pluginConfig = ServerStatsHytaleConfig.load(this);
  ...
  protected void start() {
    ...
    if (!configValid) {
      getLogger()
        .atSevere()
        .log("Cannot enable ServerStats - invalid configuration!");
      return;
    }
    ...
    // Register commands
    getCommandRegistry().registerCommand(new ServerStatsCommand(this));
  ...
  protected void shutdown() {
    ...
    getLogger().atInfo().log("ServerStats disabled");
    super.shutdown();
  }
   ...
   */
  public ServerStatsHytaleConfig getPluginConfig() {
    return pluginConfig;
  }
