package net.analyse.spigot.update;
...
public class SpigotUpdateChecker {
  ...
  public void sendUpdateMessage(Player player, String currentVersion, String newVersion, String downloadUrl) {
    MessageUtil.sendMessage(player, "<dark_gray><strikethrough>                                                </strikethrough></dark_gray>");
    MessageUtil.sendMessage(player, "<aqua><bold>Analyse</bold></aqua> <dark_gray>»</dark_gray> <gray>A new version is available!</gray>");
    MessageUtil.sendMessage(player, "<gray>Current: <red>%current%</red> <dark_gray>→</dark_gray> Latest: <green>%latest%</green></gray>",
        "current", currentVersion, "latest", newVersion);
    MessageUtil.sendMessage(player, "<gray>Download: <white>%url%</white></gray>", "url", downloadUrl);
    MessageUtil.sendMessage(player, "<dark_gray><strikethrough>                                                </strikethrough></dark_gray>");
  }
