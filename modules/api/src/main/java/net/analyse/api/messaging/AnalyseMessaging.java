...
/**
 * Utility class for sending Analyse events via plugin messaging.
 ...
 * }</pre>
 */
public final class AnalyseMessaging {

  /**
   * The plugin messaging channel for Analyse events
   */
  public static final String CHANNEL = "analyse:events";
