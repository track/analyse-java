...
/**
 * Base interface for all Analyse addons.
 * Addons must implement this interface and be annotated with {@link AddonInfo}.
 *
 * <p>Addon lifecycle:</p>
 * <ol>
 *   <li>{@link #onLoad(AnalysePlatform, AddonLogger, Path)} - Called when addon is loaded</li>
 ...
 *
 *     private AnalysePlatform platform;
...
public interface Addon {
     ...
     */
    void onLoad(AnalysePlatform platform, AddonLogger logger, Path dataFolder);
